...
\item[] \textit{In preparation:} \textbf{Morrow, D. J.}; Ma, X. Trapping Interlayer Excitons in van der Waals Heterostructures by Potential Arrays.
...
\item[] \textit{Submitted:} Lohmann, S.; Cai, T.; \textbf{Morrow, D. J.}; Chen, O.; Ma, X. Brightening of Dark States in CsPbBr\textsubscript{3} Quantum Dots Caused by Light-Induced Magnetism.
