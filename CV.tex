...
\name{\AuthorName}
\address{Scientific Software Developer at Emerald Cloud Lab}
...
\address{\href{mailto:darienmorrow@gmail.com}{\texttt{darienmorrow@gmail.com}}}




\begin{document}
I build computationally reproducible acquisition, analysis, simulation, and representation pipelines.\\
...
\begin{rSubsection}{Emerald Cloud Lab}{2023 - Present}{Scientific Software Developer}{}
	\item Empowering end-to-end remote life-science research
\end{rSubsection}

\begin{rSubsection}{Center for Nanoscale Materials at Argonne National Laboratory}{2020 - 2022}{Postdoctoral Appointee supervised by Xuedan Ma}{Lemont, IL}
...
\item[$\cdot$] \textit{Submitted:} Kohler, D. D.; \textbf{Morrow, D. J.};  Zhao, Y.; Scheeler, J. M.; Jin, S.; Wright, J. C. Spatially Resolved Spectroscopy Reveals the Disorder of WS\textsubscript{2}-MoS\textsubscript{2} Lateral Heterojunctions.

\item[$\cdot$] \textit{Submitted:} \textbf{Morrow, D. J.}; Ma, X. Noisy detectors with unmatched detection efficiency thwart identification of single photon emitters via photon coincidence correlation.\\
$\cdot$ Preprint: \href{http://arxiv.org/abs/2204.07654}{\texttt{arXiv:2204.07654}}.

\item[$\cdot$] \textit{Submitted:} \textbf{Morrow, D. J.}; Ma, X. Facile reconstruction of time-resolved fluorescence data with exponentially modified Gaussians.\\
$\cdot$ Preprint: \href{http://arxiv.org/abs/2201.03561}{\texttt{arXiv:2201.03561}}.


\item Lu, S.\textsuperscript{$\dagger$}; \textbf{Morrow, D. J.}\textsuperscript{$\dagger$};Li, Z.; Yu, X.; Wang, H.; Schultz, J. D.; O'Connor, J. P.; Jin, N.; Fang, F.; Wang, W.; Cui, R.; Chen, O.; Su, S.; Wasielewski, M. R.; Ma, X.; Li, X.  Encapsulating Semiconductor Quantum Dots in Supramolecular Cages Enables Ultrafast Guest–Host Electron and Vibrational Energy Transfer \emph{Journal of the American Chemical Society}. \href{http://pubs.acs.org/doi/10.1021/jacs.2c11981}{\texttt{DOI: 10.1021/jacs.2c119816}}. \textbf{2017}. \\
$\dagger$: equal author contribution 


\item Chen, J-S.; Dasgupta, A.; \textbf{Morrow, D. J.}; Emmanuele, R.; Marks, T. J.; Hersam, M. C.; Ma, X. Room Temperature Lasing from Semiconducting Single-Walled Carbon Nanotubes. \emph{ACS Nano}. \href{https://doi.org/10.1021/acsnano.2c06419}{\texttt{DOI: 10.1021/acsnano.2c06419}}. \textbf{2022}.
...
\begin{etaremune}
	\item Presentation. \textbf{Darien J. Morrow}, Zhengjie Huang, Jia-Shiang Chen, Xuedan Ma. Spin triplets in carbon nanotubes with sp\textsuperscript{3} defects. 8\textsuperscript{th} Workshop on Nanotube Optics and Nanospectroscopy (WONTON). 2022.
...
\begin{itemize}[leftmargin = 0 pt]
	\item Member of Argonne's Nanoscience and Technology
	Diversity, Equity, and Inclusion (DEI) Working Group. 2021-present 
	...
	\item Journal Reviewer: \emph{Journal of Chemical Physics}, \emph{Physical Review Letters}, \emph{Physical Review B}
	\item Served on panel to talk to KU REU students about navigating career options outside of the academy. Summer 2022.
	...
	\item Served on panel to talk to UW REU students about experiences applying to and surviving graduate school. Summer 2017.
