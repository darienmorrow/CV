...
\begin{rSubsection}{Center for Nanoscale Materials at Argonne National Laboratory}{2020 - Present}{Postdoctoral Appointee supervised by Xuedan Ma}{Lemont, IL}
	\item Researching excitonic and electronic properties of doped low-dimensional materials as photonic sources for Quantum Information Science
	\item Developing a near-IR, cryogenic, paramagnetic spin resonance microscope 
\end{rSubsection}
...
\item[] \textit{In preparation:} \textbf{Morrow, D. J.}; Kohler, D. D.; Zhao, Y.; Scheeler, J. M.; Jin, S.; Wright, J. C. Sub-picosecond coherent modulation of broadband optical harmonic generation in graphene.
...
\item[] \textit{In preparation:} Kohler, D. D.; \textbf{Morrow, D. J.};  Zhao, Y.; Scheeler, J. M.; Jin, S.; Wright, J. C. Spatially Resolved Spectroscopy Reveals the Disorder of WS\textsubscript{2}-MoS\textsubscript{2} Lateral Heterojunctions.




\item[] \textit{Submitted:} Lu, S.\textsuperscript{$\dagger$}; \textbf{Morrow, D. J.}\textsuperscript{$\dagger$};Li, Z.; Yu, X.; Wang, H.; Schultz, J. D.; O'Connor, J. P.; Jin, N.; Fang, F.; Wang, W.; Cui, R.; Chen, O.; Su, S.; Wasielewski, M. R.; Ma, X.; Li, X.  Encapsulating Semiconductor Quantum Dots in Supramolecular Cages Enables Ultrafast Guest–Host Electron and Vibrational Energy Transfer \\
$\dagger$: equal author contribution 

\item[] \textit{Submitted:} \textbf{Morrow, D. J.}; Ma, X. Noisy detectors with unmatched detection efficiency thwart identification of single photon emitters via photon coincidence correlation.\\
...
\begin{itemize}[leftmargin = 0 pt]
	...
	\item Journal Reviewer: \emph{Journal of Chemical Physics}, \emph{Physical Review Letters}
